...
{
		return HAL_I2C_Master_Transmit(&BH1750_IIC, BH1750_ADDR_WRITE, (uint8_t*)&cmd, 1, 0xFFFF);
}
/**
...
{
	return HAL_I2C_Master_Receive(&BH1750_IIC, BH1750_ADDR_READ, dat, 2, 0xFFFF);
}
/**
